...
<div style="max-width: 400px; margin: 0 auto;">
    ...
    <!-- 회원가입 버튼 -->
    <button id="signup-btn" onclick="location.href='../user/joinForm'" style="width: 100%; padding: 10px; margin-top: 10px; background-color: #3498DB; color: white; border: none; border-radius: 3px; cursor: pointer;">회원가입</button>
</div>
<script>
